<template>
  <div class="Saleliet_body">
    <!-- 头部 -->
    <div>
      <h2 style="font-size: 28px">客户列表</h2>
      <!-- 下拉框 -->
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="name" label="名字">
          <template slot-scope="scope">
            <p v-show="!scope.row.disable">{{ scope.row.name }}</p>
            <el-input
        ...
        <el-table-column prop="name_cn" label="权限"> </el-table-column>
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            >
            <el-button
              style="background-color: #f0f2f5; margin: 0"
